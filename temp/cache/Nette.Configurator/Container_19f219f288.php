<?php
// source: C:\xampp\htdocs\src\nettecms\app/config/config.neon 
// source: C:\xampp\htdocs\src\nettecms\app/config/config.local.neon 

class Container_19f219f288 extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'security.user',
					'session.session',
					'25_App_Model_CalculatorManager',
					'26_App_Model_LoginManager',
					'application.1',
					'application.2',
					'application.3',
					'application.4',
			...
			'Nette\Application\Routers\SimpleRouter' => array(1 => array('routing.router')),
			...
			'App\Model\CalculatorManager' => array(
				1 => array('25_App_Model_CalculatorManager'),
			),
			'App\Model\LoginManager' => array(1 => array('26_App_Model_LoginManager')),
			...
			'App\Presenters\CalculatorPresenter' => array(array('application.2')),
			'App\Presenters\ErrorPresenter' => array(array('application.3')),
			'App\Presenters\HomepagePresenter' => array(array('application.4')),
			'App\Presenters\LoginPresenter' => array(array('application.5')),
		...
		'services' => array(
			'25_App_Model_CalculatorManager' => 'App\Model\CalculatorManager',
			'26_App_Model_LoginManager' => 'App\Model\LoginManager',
			'application.1' => 'App\Presenters\ArticlePresenter',
			'application.2' => 'App\Presenters\CalculatorPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\xampp\htdocs\src\nettecms\app',
			'wwwDir' => 'C:\xampp\htdocs\src\nettecms\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\xampp\htdocs\src\nettecms\app/../temp',
		));
	}


	/**
	 * @return App\Model\CalculatorManager
	 */
	public function createService__25_App_Model_CalculatorManager()
	{
		$service = new App\Model\CalculatorManager;
		return $service;
	}
	 ...
	 */
	public function createService__26_App_Model_LoginManager()
	{
		$service = new App\Model\LoginManager;
		return $service;
	}
	...
	/**
	 * @return App\Presenters\CalculatorPresenter
	 */
	public function createServiceApplication__2()
	{
		$service = new App\Presenters\CalculatorPresenter($this->getService('25_App_Model_CalculatorManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\src\nettecms\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\xampp\htdocs\src\nettecms\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\src\nettecms\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_19f219f288_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\xampp\htdocs\src\nettecms\app/../temp/cache/latte');
	...
	public function createServiceRouting__router()
	{
		...
		if (!$service instanceof Nette\Application\Routers\SimpleRouter) {
			throw new Nette\UnexpectedValueException('Unable to create service \'routing.router\', value returned by factory is not Nette\Application\Routers\SimpleRouter type.');
		}
		return $service;
	}
...
final class Container_19f219f288_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

	private $container;


	public function __construct(Container_19f219f288 $container)
	{
