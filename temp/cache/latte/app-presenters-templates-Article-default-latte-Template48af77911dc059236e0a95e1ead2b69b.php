<?php
// source: C:\xampp\htdocs\src\nettecms\app\presenters/templates/Article/default.latte

class Template48af77911dc059236e0a95e1ead2b69b extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1f59536b23', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb2c7fefc449_content')) { function _lb2c7fefc449_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
<div id="content">
<?php call_user_func(reset($_b->blocks['info']), $_b, get_defined_vars())  ?>
    
    

	<div class="boxes">
		<h2>Iam component <strong>Article</strong></h2>
		<strong><?php echo Latte\Runtime\Filters::escapeHtml($control->name, ENT_NOQUOTES) ?></strong>
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb7614978b7d_title')) { function _lb7614978b7d_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block menu
//
if (!function_exists($_b->blocks['menu'][] = '_lbff02ffd33b_menu')) { function _lbff02ffd33b_menu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="menu">
	<ul>
...
">Sing in </a></li>
		<li><a href='Article:show'>Try</a></li>
	</ul><?php
}}
...
// block info
//
if (!function_exists($_b->blocks['info'][] = '_lb904ece93bb_info')) { function _lb904ece93bb_info($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>    	<p>You can post article !</p>
