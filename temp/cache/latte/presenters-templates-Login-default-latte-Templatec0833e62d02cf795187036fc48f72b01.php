<?php
// source: C:\xampp\htdocs\src\nettecms\app\components/../presenters/templates/Login/default.latte

class Templatec0833e62d02cf795187036fc48f72b01 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b7aacad58e', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb82cbd6180b_content')) { function _lb82cbd6180b_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb36a96dec0f_title')) { function _lb36a96dec0f_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>	<h1>Login</h1>
<?php
}}
...
// block menu
//
if (!function_exists($_b->blocks['menu'][] = '_lb4d8d83dd12_menu')) { function _lb4d8d83dd12_menu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="menu">
	<ul>
...
// block info
//
if (!function_exists($_b->blocks['info'][] = '_lb531785c726_info')) { function _lb531785c726_info($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
